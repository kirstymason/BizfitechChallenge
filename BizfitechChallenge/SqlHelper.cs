...
namespace CMInternal
{
    ...
    public static class SqlHelper
    {
        ...
        public static SqlParameter[] GetSpParameterSetPublic(SqlConnection connection, string spName)
        {
        ...
        public static string GetConnectionString
        {
            get
            {
                ...
                // Pick Data from WEb.config  to identify if system is online or Offline  ---- Added by Praneeth 
                if (ConfigurationSettings.AppSettings["appMode"].ToString() == "Online")
                {
                    strConnectionString = string.Format(ConfigurationSettings.AppSettings["connectionstring"], ConfigurationSettings.AppSettings["username"], ConfigurationSettings.AppSettings["password"]);
                }
                else
                {
                    //strConnectionString = "Data Source=.\\SQLEXPRESS;AttachDbFileName=|DataDirectory|ClassRoomMonitor.mdf;Integrated Security =True;User Instance=True";
                    strConnectionString = string.Format(ConfigurationSettings.AppSettings["ConnectionStringOffline"]);
                }
                //AVOConnectionString = "initial catalog=AVO;server=master;uid=sa;pwd=sql@iridium";
        ...
        public static string GetServerName
        {
            get
            {
                string strGetServerName;
                strGetServerName = ConfigurationSettings.AppSettings["servername"];
                //AVOConnectionString = "initial catalog=AVO;server=master;uid=sa;pwd=sql@iridium";
                return strGetServerName;
            }
        ...
        public static void FixCommand(SqlCommand cmd)
        {
        ...
        public static DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            bool mustCloseConnection = false;
            PrepareCommand(cmd, connection, (SqlTransaction)null, commandType, commandText, commandParameters, out mustCloseConnection);
            cmd.CommandTimeout = 300;  // Added by Meenakshi B to increase CommandTimeout from 30 (default) to solve issue related to school id 212 
        ...
        {
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteReader(GetConnectionString, commandType, commandText, (SqlParameter[])null);
        }
        ...
        {
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteXmlReader(GetConnectionString, commandType, commandText, (SqlParameter[])null);
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(String spName, DataRow dataRow)
        {
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        {
            return GetSpParameterSet(SqlHelper.GetConnectionString, spName, false);
        }
    ...
    public sealed class ModHelper
    {
        ...
        public static void ErrorLog(string a_applicationType, string a_moduleName, string a_message)
        {
            SqlDataReader dr;
            SqlParameter[] param = new SqlParameter[3];
            param[0] = ModHelper.CreateParameter("@AppType", SqlDbType.VarChar, 50, ParameterDirection.Input, a_applicationType);
            param[1] = ModHelper.CreateParameter("@ModuleName", SqlDbType.VarChar, 50, ParameterDirection.Input, a_moduleName);
            param[2] = ModHelper.CreateParameter("@ErrorDescription", SqlDbType.VarChar, 8000, ParameterDirection.Input, a_message);
            dr = SqlHelper.ExecuteReader(CommandType.StoredProcedure, "LogError", param);
            dr.Close();
        }
        ...
        public static void LogError(string Message)
        {
            ...
            //			string strSerName;
            //			strSerName = SqlHelper.GetServerName;
            //			if(System.Diagnostics.EventLog.Exists("AVO") == false)
            //			{
            //				System.Diagnostics.EventLog.CreateEventSource("AVOAPP", "AVO", strSerName);
            //			}
            //
            //			System.Diagnostics.EventLog AVOLog = new System.Diagnostics.EventLog();
            //			AVOLog.Log = "AVO";
            //			AVOLog.Source = "AVO";
            //			AVOLog.WriteEntry(Message, System.Diagnostics.EventLogEntryType.Error);
